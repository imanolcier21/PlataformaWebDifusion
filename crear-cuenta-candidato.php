		...
		<div class="row">
			<div class="col-12">
				<div class="bread-inner">
					<!-- Bread Menu -->
					<!-- Bread Title -->
					<div class="bread-title"><h2 id="titulos">Crear Cuenta Candidato.</h2></div>
				</div>
			</div>
		</div>
	</div>
    			...
    			if (!regcampos.test(nombres)){
    				...
    				if(nombres.length<=3 ){
    					...
    					$.ajax({
    						...
    						type: 'POST' ,
    						dataType: 'html',
    						data: {correo:Email,Cargo:'Candidato',Nombre:nombres,Apellidos:apellidos,password:password1},
