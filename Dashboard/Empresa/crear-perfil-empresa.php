  ...
  <div class="">
    <div class="content content-top text-center overflow-hidden">
      <div class="pt-40 pb-20">
        ...
        <h2 class="h4 font-w400  invisible" id="titulos"  style="color: white;" data-toggle="appear" data-class="animated fadeInUp">crea el perfil de tu empresa</h2>
      </div>
    </div>
  </div>
</div>
...
<div class="col-md-5">
  ...
  <div class="block block-rounded block-themed">
    ...
    <div class="block-content block-content-full">
     ...
     <div class="form-group row">
      <label class="col-12">Móvil del reclutador + extensi��n *</label>
      <div class="col-12">
...
<script type="text/javascript">
  $(document).ready(function() {
   ...
   $("#registroFinalizado").html('<button class="btn btn-block btn-alt-primary"   id="Guardar" name="Guardar"><i class="fa fa-save mr-5"></i>Guardar</button> ');
  ...
  $('#registroFinalizado').on('click', function() {
    ...
    if (AreaSelecionada == ""){
     ...
     $.ajax({
      ...
      type: 'POST' ,
      dataType: 'html',
      data: {usuario:"<?php echo $IDUser; ?>",areaEmpresa:AreaSelecionada,Pais:PaisSelecciona,Departamento:DepartamentoSeleccionado,NombreEmpresa:nombreEmpresa,ubicacionEmpresa:ubicacionEmpresa,descripcion:descripcion,Email:Email,telefono:telefono,celular:celular,facebook:facebook,instagram:instagram,whatsapp:whatsapp,youtube:youtube,paginaweb:paginaweb,confidencial:confidencial,nombre:"<?php echo $PrimerNombre[0]; ?>",apellido:"<?php echo $PrimerApellido[0]; ?>",razonsocial:razonsocial},
     ...
     .done(function(response) {
      ...
      if (result == 1){
        ...
        $("#registroFinalizado2").html('<a href="index?notificar=1" class="btn btn-block btn-alt-primary">Finalizar</a>');

        swal({
          title: "Perfil creado",
          text: "Las herramientas que necesitas para que tu búsqueda de candidatos sea exitosa.",
          type: "success",
        ...
        .then((willDelete) => {
          if (willDelete) {
            setTimeout("location.href='index?notificar=1'");
          } 
