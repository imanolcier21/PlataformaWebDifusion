        ...
        <div class="row">
            <div class="col-12">
                <div class="bread-inner">
                    <div class="bread-title"><h2 id="titulos">Crear Cuenta Admin.</h2></div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class='col-lg-12 col-md-12 col-12'>
                <div class="contact-form-area m-top-30">
                    <h4 id="titulos"> Registro de Administrador</h4> <hr>
    ...
    <div class="col-lg-12 col-md-12 col-12">
        <div class="contact-box-main m-top-30">
            ...
            <div class="button text-center">
                ...
                <a href="login-admin" class="bizwheel-btn theme-1">Iniciar Sesión<i class="fa fa-angle-right"></i></a>
            </div>
        </div>
    </div>
</section>
...
<script type="text/javascript">
    ...
    $('#crear-cuenta').on('click', function() {
        ...
        if($('#validarContrato').is(':checked')){
            ...
            var password2 = $('#confirmarPass').val().trim();
            ...
            if (!regcampos.test(nombres)){
                ...
                if(nombres.length<=3 ){
                    ...
                    console.log("Datos a enviar:", {correo: Email, Cargo: 'Candidato', Nombre: nombres, Apellidos: apellidos, password: password1});
                    $.ajax({
                        url: 'main/UsuarioCuentas/cuenta-admin.php',
                        type: 'POST',
                        data: {correo:Email,Cargo:'Administrador',Nombre:nombres,Apellidos:apellidos,password:password1},
                    ...
                    .done(function(response){
                        ...
                        } else if(result == 2)
                        {
                            ...
                            .then((willDelete) => {
                                if (willDelete) {
                                    setTimeout("location.href='login-admin?success=1'");
                                }
                            });


                        }else if(result == 3){
                            swal({title:'Error',text:'Intente de nuevo para procesar el envio',type:'warning'});
                        }
                        else{
                            alert(result);
                        }
